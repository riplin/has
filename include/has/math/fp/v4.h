...
public:
    inline v4() {}
    explicit inline v4(fp v) : m_x(v), m_y(v), m_z(v), m_w(v) {}
    explicit inline v4(fp x, fp y, fp z, fp w) : m_x(x), m_y(y), m_z(z), m_w(w) {}
    explicit inline v4(fp x, const v3& yzw) : m_x(x), m_y(yzw.x()), m_z(yzw.y()), m_w(yzw.z()) {}
    explicit inline v4(const v3& xyz, fp w) : m_x(xyz.x()), m_y(xyz.y()), m_z(xyz.z()), m_w(w) {}
    explicit inline v4(fp x, fp y, const v2& zw) : m_x(x), m_y(y), m_z(zw.x()), m_w(zw.y()) {}
    explicit inline v4(fp x, const v2& yz, fp w) : m_x(x), m_y(yz.x()), m_z(yz.y()), m_w(w) {}
    explicit inline v4(const v2& xy, fp z, fp w) : m_x(xy.x()), m_y(xy.y()), m_z(z), m_w(w) {}
    ...
    inline const fp& w() const { return m_w; }
    inline fp& w() { return m_w; }
    ...
    inline fp Dot(const v4& rhs) const
    { return m_x * rhs.m_x + m_y * rhs.m_y + m_z * rhs.m_z + m_w * rhs.m_w; }

    inline v4 Abs() const
    { return v4(m_x.Abs(), m_y.Abs(), m_z.Abs(), m_w.Abs()); }

    inline v4 Neg() const
    { return v4(m_x.Neg(), m_y.Neg(), m_z.Neg(), m_w.Neg()); }

    inline v4 Floor() const
    { return v4(m_x.Floor(), m_y.Floor(), m_z.Floor(), m_w.Floor()); }

    inline v4 Fraction() const
    { return v4(m_x.Fraction(), m_y.Fraction(), m_z.Fraction(), m_w.Fraction()); }

    inline const v4& operator=(const v4& rhs)
    { m_x = rhs.m_x; m_y = rhs.m_y; m_z = rhs.m_z; m_w = rhs.m_w; return (*this); }

    inline const v4& operator=(fp rhs)
    ...
    inline v4 operator+(fp rhs) const
...
inline v4 operator+(fp lhs, const v4& rhs)
